  ...
  if (empty($errors)) {
    ...
    if($user) {
      if($password === $master_password) {
        ...
        // Error message should not leak whether the attempted username is in the databse or not.
        $errors[] = "There is something wrong with the information you provided."; // TODO write an error message
      }
    } else {
      // No username found
      // Error message should not leak whether the attempted username is in the databse or not.
